 ...
 */
final class Version20230916091157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE nft (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, picture VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, quantity INT NOT NULL, release_date DATE NOT NULL, INDEX IDX_D9C7463C12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
